				...
				<div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
					...
					<div className="space-y-6">
						<div className="rounded-xl border border-border/60 bg-white shadow-sm p-6">
							...
							<div className="p-4 rounded-lg border border-border/50 bg-gray-50 flex items-center justify-between mb-4">
								<div className="flex items-center gap-3">
									<div className="h-8 w-12 bg-white border rounded flex items-center justify-center text-xs font-bold">
										GTB
									</div>
									<div>
										<p className="text-sm font-medium">Guaranty Trust Bank</p>
