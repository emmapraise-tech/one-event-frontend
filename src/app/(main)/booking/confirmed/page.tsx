      ...
      <div className="container mx-auto max-w-3xl">
                ...
                <div className="bg-white border border-neutral-200 rounded-lg p-3 flex items-center gap-3 shadow-sm">
                  ...
                  <div className="text-xs">
                    <p className="font-medium text-neutral-900">
                      {bookingData.paymentPreference === "bank"
                        ? "Paid via Transfer"
                        : "Payment Secured"}
                    </p>
                    <p className="text-neutral-500">Verified by Gateway</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex gap-4 w-full sm:w-auto">
            <Button
              ...
              onClick={() => handleUnsupported("Add to Calendar")}
            >
          ...
          <Button
            className="w-full sm:w-auto gap-2 bg-brand-gold hover:bg-brand-gold-hover text-white h-12 px-8 rounded-xl font-bold shadow-lg shadow-amber-500/20"
        ...
        <div className="mt-12 text-center text-sm text-neutral-500">
          <p>
            ...
            or{" "}
            <Link
              href="mailto:support@oneevent.com"
              className="font-medium text-brand-blue hover:underline"
            >
              contact support
            </Link>
