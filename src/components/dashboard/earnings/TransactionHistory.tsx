								...
								>
									...
									<td className="px-6 py-4">
										<div className="flex items-center gap-3">
											<div
												className={`p-2 rounded-full ${tx.type === TransactionType.INFLOW ? 'bg-blue-50' : 'bg-gray-100'}`}
											>
												{getTypeIcon(tx.type)}
											</div>
									...
									<td
										className={`px-6 py-4 font-semibold ${tx.type === TransactionType.INFLOW ? 'text-primary' : 'text-gray-900'}`}
									>
